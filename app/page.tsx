...
function CommerceHome({enter,cartItems,clearCart}:{enter:()=>void;cartItems:Product[];clearCart:()=>void}){
 const edits=byIds(["red-knit","ivory-top","rugby","cargo","relaxed-denim","windbreaker","lilac-cardigan","utility-jacket","baguette","canvas-tote"]);
