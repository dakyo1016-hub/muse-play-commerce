...
export default function GodotSite(){
 return <main className="godot-site-host"><iframe src="/game/index.html" title="MUSE — Shopping as a Game" allow="autoplay; fullscreen; gamepad" loading="eager"/><a className="godot-tryon-entry" href="/try-on" target="_top"><span>NEW</span><b>AI 피팅</b><i>→</i></a></main>;
}
